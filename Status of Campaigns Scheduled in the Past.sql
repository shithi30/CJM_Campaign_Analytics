/*
- Viz: https://docs.google.com/spreadsheets/d/1cfP1Y4fuSiCymqrwsmlWRqYz6jGhZSgH1mpPvF1XO5g/edit#gid=1883236022
- Data: 
- Function: 
- Table:
- Instructions:
...
begin  
	...
	truncate table data_vajapora.past_sch_stats; 
	...
	loop
		delete from data_vajapora.past_sch_stats
		where schedule_date=var_date;
	
		-- status of past schedules
		insert into data_vajapora.past_sch_stats
		select 
...
select * 
from data_vajapora.past_sch_stats
where 
	campaign_id like '%-%'
